...
public class BANK_MINI003 {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			System.out.print("□ 비밀번호 : "); pass= scanner.next();
			System.out.print("□ 잔	액 : "); balance= scanner.nextDouble();
			System.out.println("설정되어 있습니다." );
			break;
		case 2:
			System.out.println("□ 조회기능입니다.");
			System.out.print("본인확인ID : "); id= scanner.next();
			System.out.print("본인확인pass : "); pass= scanner.next();
			if(id.equals("") && pass.equals("")) {
				System.out.println("==반갑습니다 고객님");
				System.out.println("ID : " + id);
				System.out.println("pass : " + pass);
				System.out.println("balance : " + balance);
			} else System.out.println("다시 확인해 주세요."); break;
		case 3:
